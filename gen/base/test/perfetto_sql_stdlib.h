...
const char kEventLatency[] = R"_d3l1m1t3r_(-- Copyright 2024 The Chromium Authors
-- Use of this source code is governed by a BSD-style license that can be
-- found in the LICENSE file.
...
const char kScrollInteractions[] = R"_d3l1m1t3r_(-- Copyright 2024 The Chromium Authors
-- Use of this source code is governed by a BSD-style license that can be
-- found in the LICENSE file.
...
const char kScrollJankPredictorError[] = R"_d3l1m1t3r_(-- Copyright 2024 The Chromium Authors
-- Use of this source code is governed by a BSD-style license that can be
-- found in the LICENSE file.
...
const FileToSql kFileToSql[] = {
  ...
  {"event_latency.sql", kEventLatency},
  ...
  {"scroll_interactions.sql", kScrollInteractions},
  ...
  {"scroll_jank/predictor_error.sql", kScrollJankPredictorError},
